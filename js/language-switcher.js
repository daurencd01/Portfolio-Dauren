...
const translations = {
    en: {
        ...
        hr: { tooltip: "Recruiter view — clean summary with CV, contacts & key facts", available: "Open to work · Astana, Kazakhstan", exp_label: "Experience", exp_val: "SOC Analyst L1 · Blue Team — Sauyt Lab, Sr Holding", edu_label: "Education", edu_val: "Astana IT University — Cybersecurity, 3rd year", cert_label: "Certifications", cert_val: "Red Hat RH124 · CyberShield CSCSA (STS)", lang_label: "Languages", lang_val: "Kazakh · Russian C1 · English B1 · Chinese HSK5" },
